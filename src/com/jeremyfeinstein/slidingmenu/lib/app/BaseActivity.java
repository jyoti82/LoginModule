...
public class BaseActivity extends Activity {
		...
		if (actionBar != null) {
			...
			if (metaData != null) {
				...
				if (isTop) {
					...
					//icon.setImageDrawable(ThemeService.getPressedButtonDrawable(R.drawable.more_on));
					icon.setImageResource(R.drawable.more_on);
					titleMarginLeft = (int) getResources().getDimension(R.dimen.title_left_margin_isTop);
				}
				// add Back Icon
				else {
					//icon.setImageDrawable(ThemeService.getPressedButtonDrawable(R.drawable.back_on));
					icon.setImageResource(R.drawable.back_on);
	...
	private void createTopBarLayout() {
		...
		actionBarView = inflater.inflate(R.layout.top_action_bar, null);
		search = (ImageView) actionBarView.findViewById(R.id.search_icon);
		search.setImageResource(R.id.search_icon);
		//search.setImageDrawable(ThemeService.getPressedButtonDrawable(R.drawable.search_on));
